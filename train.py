...
def reconstruction(args):
    ...
    # init dataset
    dataset = dataset_dict[args.dataset_name]
    train_dataset = dataset(args.datadir, split='train', downsample=args.downsample_train, is_stack=False, scene_box=args.scene_box, near_far=args.near_far)
    test_dataset = dataset(args.datadir, split='test', downsample=args.downsample_train, is_stack=True, scene_box=args.scene_box, near_far=args.near_far)
    ...
    optimizer = jt.optim.Adam(grad_vars, lr=1e-3, betas=(0.9,0.99))
